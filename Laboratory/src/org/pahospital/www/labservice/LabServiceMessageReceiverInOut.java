 ...
 */
        ...
        */
        ...
        LabServiceSkeleton skel = (LabServiceSkeleton)obj;
        //Out Envelop
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("orderLabTest".equals(methodName)){
                ...
                org.pahospital.www.labservice.LabOrderId labOrderId1 = null;
	                        org.pahospital.www.labservice.LabOrder wrappedParam =
                                    ...
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
                                        ...
                                        envelope = toEnvelope(getSOAPFactory(msgContext), labOrderId1, false, new javax.xml.namespace.QName("http://www.PAHospital.org/LabService/",
                                                    "orderLabTest"));
